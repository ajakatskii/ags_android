...
public class CameraSource {
    ...
    static RadiusOverlayView mOverlay;
    static boolean captureNextPreviewFrame = false;
    static boolean displayPreviewFrame = false;
    ...
    private class CameraPreviewCallback implements Camera.PreviewCallback {
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            if(captureNextPreviewFrame && displayPreviewFrame) {
                captureNextPreviewFrame = false;
                ...
                mOverlay.setPicture(bytes); // Capture of preview to display to the user
            }
